...
// D) Upcoming Recurring Bills
//    On récupère toutes les transactions récurrentes, puis on calcule
//    en PHP la PROCHAINE date d'échéance à partir de la fréquence.
                ...
                if ($result_upcoming) {
                    ...
                    while ($row = mysqli_fetch_assoc($result_upcoming)) {
                        ...
                        // Avance la date jusqu'à ce qu'elle soit aujourd'hui ou plus tard
                        if ($interval) {
                            while ($next < $today) {
                    ...
                    // Trie par prochaine échéance, garde les 5 premières
